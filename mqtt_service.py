...
class RedisSubscriber:
    ...
    def __init__(self, redis_host: str, redis_port: int, redis_channel: str, mqtt_handler: MQTTHandler):
            ...
            for message in self.pubsub.listen():
                if message["type"] == "message":
                    try:
                        ...
                        logging.error(f"Failed to decode JSON from Redis: {message['data']}")
        except Exception as e:
...
if __name__ == "__main__":
    ...
    redis_subscriber = RedisSubscriber(REDIS_HOST, REDIS_PORT, REDIS_CHANNEL, mqtt_handler)
